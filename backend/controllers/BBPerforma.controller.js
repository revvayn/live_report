...
const getKedatanganGrader = async (req, res) => {
  ...
  ROUND(AVG(CASE WHEN group_rotary ILIKE 'LOG 5%' THEN diameter END), 2) AS log5_avg_dia,
  ...
  ROUND(AVG(CASE WHEN group_rotary ILIKE 'LOG 9%' THEN diameter END), 2) AS log9_avg_dia,
